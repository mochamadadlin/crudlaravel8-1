...
<div class="wrapper">
  ...
  <div class="preloader flex-column justify-content-center align-items-center">
    <img class="animation__wobble" src="{{ asset('template/dist/img/wijaya.png') }}" alt="AdminLTELogo" height="100" width="100">
  </div>
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href class="brand-link">
      <img src="{{ asset('template/dist/img/wijayatoyota.png') }}" alt="AdminLTE Logo" class="brand-image img-square elevation-9">
...
{{--           
  ...
  <footer class="main-footer">
    <strong>Copyright &copy; 2023 <a href="https://adminlte.io">IT HO Wijaya Toyota</a>.</strong>
    All rights reserved.
